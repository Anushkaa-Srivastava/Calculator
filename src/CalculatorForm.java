...
class CalculatorForm extends JFrame implements ActionListener, MouseListener
{
    ...
    char op;
    JLabel label;
    JButton button1, button2, button3,button4,button5,button6,button7,button8,button9,button0, buttonDot, buttonEq, buttonA, buttonS, buttonD, buttonM, buttonBS, buttonCL;
    JPanel panel;
    CalculatorForm()
    {
        super("MyCalculator");
